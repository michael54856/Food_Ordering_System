<?php
    ...
    $sql = "SELECT number, account,content, orderTime, price, status,feedback FROM orderlist WHERE restaurant='{$restaurantName}' AND (status='completed' OR status='canceled')";
